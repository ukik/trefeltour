<template>
  ...
  <!-- header -->
    <header v-if="false" class="header-table vs-table--header">
...
export default {
  ...
  methods: {
    ...
    changeCheckedMultiple() {
        console.log('changeCheckedMultiple')
      const lengthx = this.data.length;
      const lengthSelected = this.value.length;
    ...
    handleCheckbox(tr) {
      ...
      if (this.multiple && this.onlyClickCheckbox) {
        console.log('handleCheckbox', val, tr)
