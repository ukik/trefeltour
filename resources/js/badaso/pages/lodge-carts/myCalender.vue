<template>
    ...
    <div class="container">
      ...
      'rangeStatus'
      <div style="height: 300px;">
        <calendar @drawDate="onDrawDate" v-model="value" :rangeStatus="2" :disabled-days-of-week="disabled" :format="format" :clear-button="clear" :placeholder="placeholder" :pane="2" :has-input="false" :on-day-click="onDayClick2" :special-days="_dateMap">
        </calendar>
        <p>{{date2}}</p>
      </div>
