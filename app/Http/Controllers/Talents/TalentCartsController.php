...
class TalentCartsController extends Controller
{
    ...
    public function edit(Request $request)
    {
        ...
        try {
            ...
            $table_entity = \TalentCarts::where('id', $request->data['id'])->first();
            ...
            \TalentCarts::where('id', $request->data['id'])->update($data);
            $updated['old_data'] = $table_entity;
            $updated['updated_data'] = \TalentCarts::where('id', $request->data['id'])->first();
