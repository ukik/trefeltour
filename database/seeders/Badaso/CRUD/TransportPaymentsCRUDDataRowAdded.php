        ...
        try {
            ...
            \DB::table('badaso_data_rows')->insert(array (
                ...
                array (
                    ...
                    'delete' => 0,
                    'details' => '{}',
                    'relation' => '{"relation_type":"belongs_to","destination_table":"transport_bookings","destination_table_column":"id","destination_table_display_column":"uuid","destination_table_display_more_column":["id","customer_id","driver_id","vehicle_id","uuid"]}',
                    'order' => 2,
                ),
                2 => 
                array (
                ...
                array (
                    ...
                    'type' => 'number',
                'display_name' => 'Total Tagihan Akhir (Rp)',
                    'required' => 0,
                    'browse' => 1,
                    'read' => 1,
                    'edit' => 1,
