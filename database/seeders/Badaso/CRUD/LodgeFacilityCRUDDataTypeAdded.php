    ...
    public function run()
    {
        ...
        try {
            ...
            \DB::table('badaso_data_types')->insert(array (
                'name' => 'lodge_facility',
                'slug' => 'lodge-facility',
                'display_name_singular' => 'Lodge Facility',
                'display_name_plural' => 'Lodge Facility',
                'icon' => NULL,
                'model_name' => NULL,
                'policy_name' => NULL,
                ...
                'notification' => '[]',
                'is_soft_delete' => true,
                'updated_at' => '2024-03-03T07:08:20.000000Z',
            ...
            if (!is_null($menu_item)) {
                ...
                $menu_item->title = 'Lodge Facility';
