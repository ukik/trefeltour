    ...
    public function run()
    {
        ...
        try {
            ...
            \DB::table('badaso_data_types')->insert(array (
                'name' => 'lodge_profiles',
                'slug' => 'lodge-profiles',
                'display_name_singular' => 'Lodge Profiles',
                'display_name_plural' => 'Lodge Profiles',
                'icon' => NULL,
                'model_name' => NULL,
                'policy_name' => NULL,
                ...
                'notification' => '[]',
                'is_soft_delete' => true,
                'updated_at' => '2024-03-02T13:21:17.000000Z',
            ...
            if (!is_null($menu_item)) {
                ...
                $menu_item->title = 'Lodge Profiles';
